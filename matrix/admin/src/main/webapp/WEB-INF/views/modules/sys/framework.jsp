...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="${ctx}/static/css/cobeetab.css" />
	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								...
								<ul class="submenu">
									<li class="">
										<a class="CB_menuItem" href="${ctx }/index/topMenu" data-index="1" >
											<i class="menu-icon fa fa-caret-right"></i>
											Top Menu
										</a>
							...
							<li class="">
								<a class="CB_menuItem" href="${ctx }/index/jqueryUI" data-index="2" >
									<i class="menu-icon fa fa-caret-right"></i>
									jQuery UI
								</a>
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="${ctx }/test/jqgrid.html" class="CB_menuItem" data-index="3" >
									<i class="menu-icon fa fa-caret-right"></i>
									jqGrid plugin
								</a>
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<!-- <ul class="breadcrumb">
						  ...
						  <div class="content-tabs">
			                <button class="roll-nav roll-left CB_tabLeft"><i class="fa fa-backward"></i>
			                </button>
			                <nav class="page-tabs CB_menuTabs">
			                    <div class="page-tabs-content">
			                         <a href="javascript:;" class="active CB_menuTab" data-id="${ctx}/index/contentIndex">首页</a>
			                    </div>
			                </nav>
			                <button class="roll-nav roll-right CB_tabRight"><i class="fa fa-forward"></i>
			                </button>
			                <div class="btn-group roll-nav roll-right">
			                    <button class="dropdown CB_tabClose"  data-toggle="dropdown">关闭操作<span class="caret"></span>
			
			                    </button>
			                    <ul role="menu" class="dropdown-menu dropdown-menu-right">
			                        <li class="CB_tabShowActive"><a>定位当前选项卡</a>
			                        </li>
			                        <li class="divider"></li>
			                        <li class="CB_tabCloseAll"><a>关闭全部选项卡</a>
			                        </li>
			                        <li class="CB_tabCloseOther"><a>关闭其他选项卡</a>
			                        </li>
			                    </ul>
			                </div>
					...
					<div class="CB_mainContent"  id="content-main">
		             <iframe class="CB_iframe" name="iframe0" width="100%" height="100%" src="${ctx }/welcome.html" frameborder="0" data-id="${ctx }/index/contentIndex" seamless ></iframe>
		            </div><!-- /.page-content -->
				</div>
			</div><!-- /.main-content -->
		...
		<!--[if IE]>
			<script src="${ctx}/static/plugin/ace/assets/js/jquery-1.11.3.min.js"></script>
		<![endif]-->
		<script type="text/javascript">
		...
		<!--[if lte IE 8]>
		  <script src="${ctx}/static/plugin/ace/assets/js/excanvas.min.js"></script>
		<![endif]-->
		<script src="${ctx}/static/plugin/ace/assets/js/jquery-ui.custom.min.js"></script>
		<script src="${ctx}/static/plugin/ace/assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="${ctx}/static/plugin/ace/assets/js/jquery.easypiechart.min.js"></script>
		<script src="${ctx}/static/plugin/ace/assets/js/jquery.sparkline.index.min.js"></script>
		<script src="${ctx}/static/plugin/ace/assets/js/jquery.flot.min.js"></script>
		<script src="${ctx}/static/plugin/ace/assets/js/jquery.flot.pie.min.js"></script>
		<script src="${ctx}/static/plugin/ace/assets/js/jquery.flot.resize.min.js"></script>
		...
		<!-- application scripts -->
		<script src="${ctx}/static/plugin/layer-v3.0.3/layer/layer.js"></script>
		<script src="${ctx}/static/js/cobeetabs.js"></script>
